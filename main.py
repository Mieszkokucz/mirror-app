...
@app.get("/reflections/", response_model=list[DailyReflectionResponse])
...
@app.get("/reflections/{reflection_id}", response_model=DailyReflectionResponse)
...
@app.patch("/reflections/{reflection_id}", response_model=DailyReflectionResponse)
